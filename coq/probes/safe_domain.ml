...
let c4_dens =
  Cons ((Zpos (XO (XO (XO (XO (XI (XO (XO (XI XH))))))))), (Cons ((Zpos (XO
    (XO (XO (XO (XO (XI (XO (XO (XO (XO (XO XH)))))))))))), (Cons ((Zpos (XO
    (XO (XI (XI (XO (XI (XO (XI (XI (XO (XI XH)))))))))))), (Cons ((Zpos (XO
    (XO (XO (XO (XO (XO (XI (XO (XI (XO (XO (XO (XI (XO XH))))))))))))))),
    (Cons ((Zpos (XO (XO (XO (XO (XO (XO (XO (XI (XO (XO (XI (XO (XO (XO (XO
    XH)))))))))))))))), Nil)))))))))
...
(** val safe_domain_bool : z list -> bool **)

let safe_domain_bool dens =
  forallb (fun d ->
    match in_w63 d with
