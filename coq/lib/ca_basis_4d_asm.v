(* ============================================================================
   ca_basis_4d_asm.v —— 四维张量积无条件基组装定理（独立开发文件，会话 14 拆分）
   ----------------------------------------------------------------------------
   依赖：ca_basis_4d（探针 + 第 4 步主引擎 + 展平族 + 四重行和分解，全部 Qed）；
   本文件仅含 tensor_product_unconditional_basis_4d，独立编译，便于增量调试
   （前置依赖全部走已编译 .vo，微调只重跑本文件）。
   ============================================================================ *)
