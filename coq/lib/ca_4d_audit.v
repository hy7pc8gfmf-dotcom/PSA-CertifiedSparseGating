(* ============================================================
   ca_4d_audit —— ca_basis_4d 公理审计
   对 4D 张量积模块做 Print Assumptions 审计，记录公理脚印
   （预期零 classic，仅继承 ca_* 基础设施；nat_quad_decode_inj / min8_is_one
   应为 Closed under the global context）。
   用法：coqc -Q src ""（同 ca_basis_4d 的 load path）。
   ============================================================ *)
