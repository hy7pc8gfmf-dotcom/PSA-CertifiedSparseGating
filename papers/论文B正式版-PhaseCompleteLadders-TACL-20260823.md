...
> 实验数据不变；配套论文 A（Coq 形式化）代码状态按当前基态（合并版 `ca_merged_full_25.v`，93953 行 / 67 模块分区，
...
- **代码状态**：论文 A 的 z 区 20 探针（grid_ortho + parseval/partial/pairbound/rowsum/
  pairdirichlet/incoherence/row_rip/c4_instance/welch/uncertainty_cr/g8_synthesis_cr/g1_norm_closed/g2_mu_adj + 构造性族 pi_cr_m1a/m1b/sin_cr_m2/sqrt_cr_m3/s7_s9_mono/decidability_premium_cr）已 pro 化并入合并版 `ca_merged_full_25.v`（93953 行，
...
| 合并版 | src\ca_merged_full_25.v（93953 行，67 模块分区，20 探针并入） | ✅ MERGE_EXIT=0 |
