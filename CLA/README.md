# PSA Contributor License Agreement (CLA)

All contributors to PSA must sign a Contributor License Agreement before their pull requests can be merged. This protects both the contributor and the project.
...
PSA 采用 **Apache 2.0（公开版）+ 商业许可（企业版）** 双许可模式。CLA 确保：

- 贡献者的代码可以被 Apache 2.0 授权给全球用户
